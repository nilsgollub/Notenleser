...
/// Benutzerfreundlicher Fehler bei der Notenerkennung.
...
/// Optical Music Recognition über die Claude Vision API.
///
/// Dart hat kein offizielles Anthropic-SDK, daher wird die Messages API
/// direkt per HTTP aufgerufen. Modell: claude-opus-4-7 (High-Res-Vision).
class ClaudeService {
